...
class CalculatorLayout(QWidget):
    def __init__(self):
        ...
        layout.addWidget(QPushButton("="), 1, 1, 2, 2)
        layout.addWidget(QLabel("This is a calculator."), 1, 0)
